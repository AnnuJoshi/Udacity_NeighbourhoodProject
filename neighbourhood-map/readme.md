...
* To get the lat long info of a page(https://developers.google.com/maps/documentation/geocoding/intro)
* To get the venue id of a place visit (https://foursquare.com/user/476971721) extract the venue id from the url.
